...
/**********************************************
 ...
 function* getProductByKeyword_inStore({ keyword }) {
    try {
        const searchParams = {
            title_contains: keyword.keyword,
            mainCategoryId: keyword.category,
        ...
        console.log(searchParams)
        const result = yield call(ProductRepository.getRecordsForStore, searchParams);
...
export default function* rootSaga() {
    ...
    yield all([
        takeEvery(actionTypes.GET_PRODUCTS_BY_KEYWORD_IN_STORE, getProductByKeyword_inStore),
    ]);
