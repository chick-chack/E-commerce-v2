...
class Store extends Component {
    constructor(props) {
        super(props);
        console.log("stooooooooooooooooooooooooooooooooooooooooooooooooooooooore", props);
        this.state = {
            isQuickView: false,
        };
    }
    ...
    render() {
        ...
        // console.log("stooooooooooooooooooooooooooooooooooooooooooooooooooooooore", store);
