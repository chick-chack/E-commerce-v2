...
class Product extends Component {
    ...
    render() {
        ...
        console.log("rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr", product)
        ...
        return (
            <div className="ps-product">
                ...
                <div className="ps-product__container">
                    <Link href="/shop">
                        <a className="ps-product__vendor">{product.metaTitle_en}</a>
                    </Link>
                    <div className="ps-product__content">
                        <Link
                            href="/product/[pid]"
                            as={`/product/${product.id}`}>
                            <a className="ps-product__title">{product.name_en}</a>
                        </Link>
