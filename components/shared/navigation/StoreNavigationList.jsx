...
import PanelSearch from '../panel/StorePanelSearch';
import PanelCategories from '../panel/StorePanelCategories';
import Link from 'next/link';
import { isStaticData } from '../../../utilities/app-settings';
import { baseUrl } from '../../../repositories/Repository';
import i18next from 'i18next';
class StoreNavigationList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            menuDrawer: false,
            ...
            <div className="navigation--list">
                ...
                <div className="navigation__content">
                    ...
                    <a
                        ...
                        <span> {i18next.t('categories')}</span>
                    </a>
                    <a
                        className={`navigation__item ${
...
export default connect(mapStateToProps)(StoreNavigationList);
