...
class PanelSearch extends Component {
    ...
    handleSearch(e) {
        if (e.target.value !== '') {
            console.log("noooooooooooooooot empty", e.target.value)
            data_search = {
            ...
            console.log(" emptyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy", e.target.value)
...
export default connect(state => state)(PanelSearch);