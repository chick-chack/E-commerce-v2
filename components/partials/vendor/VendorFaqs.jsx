    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on chickchack</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on chickchack?</figcaption>
                            <p>
                                Joining and starting a shop on chickchack is free. There are three
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on chickchack. Create an chickchack account
                                ...
                                want to pay your chickchackfees).
                            </p>
                        </figure>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            ...
                            <p>
                                ...
                                chickchack will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on chickchack?</figcaption>
                        </figure>
                        <p>
                            chickchack provides a marketplace for crafters, artists and collectors to
