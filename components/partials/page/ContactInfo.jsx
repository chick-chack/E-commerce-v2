                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="mailto:contact@chickchack.com">
                                    contact@chickchack.com
                                </a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                ...
                                <a href="#">career@chickchack.com</a>
                            </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">customercare@chickchack.com</a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">vendorsupport@chickchack.com</a>
