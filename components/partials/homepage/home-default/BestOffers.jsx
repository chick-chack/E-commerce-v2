...
class BestOffers extends Component {
    ...
    render() {
        ...
        console.log("props from home  best offers", this.props);
        const products = getColletionBySlug(collections, collectionSlug);
        console.log("products from home best offers", products);
...
export default connect(state => state.collection)(BestOffers);
